...
## *********TODO: enhance the welcome and procesing incomng messages methods

class ultraChatBot():    
    def __init__(self, json):
        self.json = json
        self.dict_messages = json['data']
        self.ultraAPIUrl = 'https://api.ultramsg.com/instance27270/'
        self.token = '4eiktzwds0pn0n5c'
...
"""
        print("entered welcome and strinfg")
